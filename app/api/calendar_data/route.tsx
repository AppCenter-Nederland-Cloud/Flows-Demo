...
import {CreateCalendarAppointment, GetCalendarSuggestions} from "@/lib/CalendarFunctions";
...
export async function POST(request: Request) {
    ...
    if (action === 'INIT') {
        ...
        const initRes = EncryptFlowResponse(initData, aesKeyBuffer, initialVectorBuffer);
